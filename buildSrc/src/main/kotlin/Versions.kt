...
object Versions {
    ...
    const val androidx_databinding: String = "3.2.1" // available: "3.3.2"

    const val legacy_support_v4: String = "1.0.0" 

    const val lifecycle_extensions: String = "2.0.0" 

    const val androidx_test_espresso: String = "3.1.0" // available: "3.1.1"

    const val androidx_test_runner: String = "1.1.0" // available: "1.1.1"

    const val customtabs: String = "28.0.0" 

    const val aapt2: String = "3.2.1-4818971" // available: "3.3.2-5309881"

    const val com_android_tools_build_gradle: String = "build 'whalesay'" // available: "3.3.2"

    const val lint_gradle: String = "26.2.1" // available: "26.3.2"
    ...
    const val quickpermissions_kotlin: String = "0.4.0" // available: "0.4.1"

    const val ktlint: String = "0.29.0" // available: "0.31.0"

    const val oss_licenses_plugin: String = "0.9.3" // available: "0.9.4"

    const val play_services_oss_licenses: String = "16.0.0" // available: "16.0.2"
    ...
    const val livedata_ktx: String = "2.0.1" // available: "3.0.0"
    ...
    const val com_squareup_okhttp3: String = "3.12.0" // available: "3.14.0"
    ...
    const val mockk: String = "1.9" // available: "1.9.2"

    const val joda_time: String = "2.10.1" 

    const val junit: String = "4.12" 

    const val dokka_android_gradle_plugin: String = "0.9.17" // available: "0.9.18"

    const val org_jetbrains_kotlin: String = "1.3.21" 

    const val org_jetbrains_kotlinx: String = "1.1.0" // available: "1.1.1"

    const val robolectric: String = "4.0.2" // available: "4.2.1"

    const val se_ansman_kotshi: String = "1.0.5" // available: "1.0.6"
