package com.worldturtlemedia.whalesay.core.view.views
...
class NestedCoordinatorLayout constructor(
    context: Context,
    attrs: AttributeSet?,
    attributeSetId: Int
) : CoordinatorLayout(context, attrs, attributeSetId), NestedScrollingChild {
    ...
    override fun onStartNestedScroll(
        ...
        val handled = super.onStartNestedScroll(child, target, nestedScrollAxes, type)
    ...
    override fun onStartNestedScroll(child: View, target: View, nestedScrollAxes: Int): Boolean {
        /* Enable the scrolling behavior of our own children */
        val handled = super.onStartNestedScroll(child, target, nestedScrollAxes)
        /* Enable the scrolling behavior of the parent's other children  */
        return startNestedScroll(nestedScrollAxes) || handled
    }
